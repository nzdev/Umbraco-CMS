...
{
    public class BPlusTreeKeyValueStore<TKey, TValue> : IKeyValueStore<TKey, TValue>
    {
        ...
        public BPlusTreeKeyValueStore(BPlusTree<TKey, TValue> bplusTree, string filePath, bool localDbCacheFileExists, bool isCountEnabled,
            IIOHelper iOHelper)
        {
        ...
        public bool EnsureEnvironment(out IEnumerable<string> errors)
        {
            ...
            _iOHelper.EnsurePathExists(_filePath);

...
{
    public class KeyValueStoreNucacheRepository : INucacheRepositoryBase<int, ContentNodeKit>, INucacheMediaRepository, INucacheContentRepository
    {
        private readonly IKeyValueStore<int, ContentNodeKit> _transactableDictionary;

        public KeyValueStoreNucacheRepository(IKeyValueStore<int, ContentNodeKit> transactableDictionary)
        {
            _transactableDictionary = transactableDictionary;
        }
        public void Init()
        {
            _transactableDictionary.Init();
        }
        public ICollection<ContentNodeKit> GetAllSortedByLevelParentIdSortOrderDesc()
        {

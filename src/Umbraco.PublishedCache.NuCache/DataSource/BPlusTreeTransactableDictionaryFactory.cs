...
namespace Umbraco.Cms.Infrastructure.PublishedCache.DataSource
{
    public class BPlusTreeTransactableDictionaryFactory<TKey, TValue> : ITransactableDictionaryFactory<TKey, TValue>
    {
        ...
        protected virtual BPlusTree<TKey, TValue> GetTree(
            string filepath,
            bool exists,
            ...
            bool enableCount = false)
        {
            ...
            var options = new BPlusTree<TKey, TValue>.OptionsV2(keySerializer, valueSerializer)
            {
                ...
                FileBlockSize = GetBlockSize(_settings.CurrentValue),
                // other options?
                ReadOnly = isReadOnly,
        ...
        protected virtual int GetBlockSize(NuCacheSettings settings)
        {
            var blockSize = 4096;

...
namespace Umbraco.PublishedCache.NuCache.LiteDb.NuCache
{
    public class NuCacheMapper
    {
        public static BsonDocument SerializeContentNodeKit(ContentNodeKit cn)
        {
        ...
        public static ContentNodeKit DeserializeToContentNodeKit(BsonValue cn)
        {
